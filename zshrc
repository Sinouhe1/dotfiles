...
load-nvmrc() {
  ...
  if [ -n "$nvmrc_path" ]; then
    ...
    if [ "$nvmrc_node_version" = "N/A" ]; then
      nvm install​⬤ZSH=$HOME/.oh-my-zsh
...
# Add Pygments installation path to enable pygmentize
export PATH="$HOME/Library/Python/3.9/bin:$PATH"

# Store your own aliases in the ~/.aliases file and load them here.
[[ -f "$HOME/.aliases" ]] && source "$HOME/.aliases"ZSH=$HOME/.oh-my-zsh
...
# Created by `pipx` on 2024-09-02 18:55:31
export PATH="$PATH:/Users/sinouheferreira/.local/bin"
